...
public class SettingsActivity extends PreferenceActivity {
	...
	public void onCreate(Bundle icicle) {
		...
		Log.i("Background resource ID", Integer.toString(backgroundFromPreference(this)));
	}

	public static int backgroundFromPreference(Context mCtx) {
		int resId = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(mCtx).getString("background_list_preference", "0"));
		switch (resId) {
		case 1:
